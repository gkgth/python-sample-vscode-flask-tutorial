[![Build Status](https://dev.azure.com/gkmsaccount/python_pipeline/_apis/build/status/gkgth.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/gkmsaccount/python_pipeline/_build/latest?definitionId=18&branchName=master)
